...
require (
	...
	github.com/steadybit/advice-kit/go/advice_kit_api v1.0.0 // indirect
	...
	github.com/steadybit/discovery-kit/go/discovery_kit_sdk v1.0.8-0.20240701141113-3ab9504da602
