...
require (
	...
	github.com/steadybit/action-kit/go/action_kit_api/v2 v2.10.1-0.20251031110739-d80058909fed
	...
	github.com/steadybit/preflight-kit/go/preflight_kit_sdk/v2 v2.0.1
