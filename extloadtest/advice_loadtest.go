...
func GetAdviceDescriptionKubernetesDeploymentLoadtest() advice_kit_api.AdviceDefinition {
	return advice_kit_api.AdviceDefinition{
		...
		Label:                     "Test Advice - Kubernetes Deployment",
		...
		AssessmentQueryApplicable: "target.type=\"com.steadybit.extension_kubernetes.kubernetes-deployment\" AND steadybit.loadtest=\"true\"",
		Category:                  new("Redundancy"),
		Status: advice_kit_api.AdviceDefinitionStatus{
			ActionNeeded: advice_kit_api.AdviceDefinitionStatusActionNeeded{
				AssessmentQuery: "k8s.deployment.label.random-char=\"a\"",
				...
				Validation: &[]advice_kit_api.Validation{
					{
						...
						Description:      new("This validation creates an *experiment*. Old and boring."),
						ShortDescription: "With experiment",
						Type:             advice_kit_api.EXPERIMENT,
						Experiment:       new(advice_kit_api.Experiment(LoadFile("advice_loadtest_validation_experiment.json"))),
					}, {
						Id:                 "com.steadybit.extension-loadtest.advice.loadtest.validation.2",
						Name:               "Experiment Template Validation",
						Description:        new("This validation creates an *experiment* based on a **template**."),
						ShortDescription:   "With template",
						Type:               advice_kit_api.EXPERIMENT,
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate(LoadFile("advice_loadtest_validation_experiment_template.json"))),
					}, {
						Id:                 "com.steadybit.extension-loadtest.advice.loadtest.validation.3",
						Name:               "Experiment Template Validation - No Variables",
						Description:        new("This validation creates an *experiment* based on a **template** without any template variables."),
						ShortDescription:   "Template without template variables",
						Type:               advice_kit_api.EXPERIMENT,
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate(LoadFile("advice_loadtest_validation_experiment_template_empty.json"))),
					}, {
						Id:                 "com.steadybit.extension-loadtest.advice.loadtest.validation.4",
						Name:               "Experiment Template Validation - Invalid",
						Description:        new("This advice contains an invalid experiment template and invalid advice template syntax in the short description field."),
						ShortDescription:   "Broken advice template syntax ${target.attr('agent.hostname'),invalid}",
						Type:               advice_kit_api.EXPERIMENT,
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate("{\"foo\":\"bar\"}")),
					}, {
						Id:                 "com.steadybit.extension-loadtest.advice.loadtest.validation.5",
						Name:               "Experiment Template Validation - Unknown Action",
						Description:        new("This advice contains an unknown action."),
						ShortDescription:   "Unknown action",
						Type:               advice_kit_api.EXPERIMENT,
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate(LoadFile("advice_loadtest_validation_experiment_template_unknown_action.json"))),
					}, {
						Id:                 "com.steadybit.extension-loadtest.advice.loadtest.validation.6",
						Name:               "Experiment Template Validation - Restricted Action",
						Description:        new("This advice contains a restricted action."),
						ShortDescription:   "Restricted action",
						Type:               advice_kit_api.EXPERIMENT,
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate(LoadFile("advice_loadtest_validation_experiment_template_restricted_action.json"))),
					}, {
						...
						Description:        new("This advice contains a template with a placeholder."),
						ShortDescription:   "Template with advice placeholder",
						Type:               advice_kit_api.EXPERIMENT,
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate(LoadFile("advice_loadtest_validation_experiment_template_placeholder.json"))),
					},
				},
			},
